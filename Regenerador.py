...
NETWORK_JSON = "network_mashe.json"
EQUIPMENT_JSON = "equipament_real_marcos_corregido.json"
INPUT_CSV = "resultados_gsnr_demandas_base.csv"
OUTPUT_CSV = "resultados_gsnr_demandas_base_regenerado.csv"
