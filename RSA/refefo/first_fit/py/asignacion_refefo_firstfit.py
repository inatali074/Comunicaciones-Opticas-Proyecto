...
BASE_OCCUPATION_CSV = os.path.abspath(os.path.join(PUNTO5_DIR, "base", "first_fit", "ocupacion_base_firstfit_V2.csv"))
BASE_MAPPING_CSV = os.path.abspath(os.path.join(PUNTO5_DIR, "base", "first_fit", "mapping_lightpaths_firstfit.csv"))
BASE_DEMANDAS_CSV = os.path.abspath(os.path.join(PUNTO5_DIR, "base", "first_fit", "lista_demandas_firstfit.csv"))
...
OUTPUT_MAPPING_CSV = os.path.join(SCRIPT_DIR, "mapping_lightpaths_refefo.csv")
OUTPUT_DEMANDAS_CSV = os.path.join(SCRIPT_DIR, "lista_demandas_refefo.csv")
