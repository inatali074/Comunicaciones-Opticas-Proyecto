...
def generar_analisis_nodal():
    base_dir = "/home/maximo/opticas/TpOpticas/RSA/refefo/first_fit"
    csv_path = os.path.join(base_dir, "ocupacion_refefo_firstfit.csv")
    xlsx_path = os.path.join(base_dir, "analisis_nodal_visual_refefo.xlsx")
    ...
    mapping_csv_path = os.path.join(base_dir, "mapping_lightpaths_refefo.csv")
    mapping_dict = {}
    ...
    # ----------------------------------------------------
    dict_csv_path = os.path.join(base_dir, "lista_demandas_refefo.csv")
